...
from aliyunsdkdysmsapi.request.v20170525 import QuerySendDetailsRequest, SendSmsRequest
...
def runsend(uper):
    ...
    params = "{\"name\":\"%s\",\"product\":\"木木睡没\"}" % uper

    print send_sms(__business_id, "18673312624", "木木睡没", "SMS_109340343", params)


if __name__ == '__main__':
    cp = ConfigParser.ConfigParser()
    cp.read('uplist.txt')
    upname = cp.get(sys.argv[1], sys.argv[2])
    runsend(upname)
